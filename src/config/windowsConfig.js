...
export const initialWindowsConfig = [
  { id: "about", title: "About", isOpen: true, type: "window", defaultWidth: vw(0.5), defaultHeight: vh(0.8) },
  { id: "projects", title: "Projects", isOpen: false, type: "window", defaultWidth: vw(0.5), defaultHeight: vh(0.8) },
  { id: "notepad", title: "Notes", isOpen: false, type: "window", defaultWidth: vw(0.5), defaultHeight: vh(0.8) },
  { id: "contact", title: "Contact", isOpen: false, type: "window", defaultWidth: vw(0.5), defaultHeight: vh(0.8) },
  { id: "terminal", title: "Terminal", isOpen: false, type: "window", defaultWidth: vw(0.5), defaultHeight: vh(0.8) },
  { id: "resume", title: "Resume", isOpen: false, type: "window", defaultWidth: vw(0.5), defaultHeight: vh(0.8) },
