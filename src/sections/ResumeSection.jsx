...
import { FaCss3, FaGithub, FaLinkedin, FaCode } from 'react-icons/fa';
import {
  SiJavascript,
  SiTypescript,
  SiPython,
...
const iconMap = {
  ...
  'C++': <TbBrandCpp />, 'HTML5': <SiHtml5 />, 'CSS3': <FaCss3 />,
  'React.js': <SiReact />, 'Next.js': <SiNextdotjs />, 'Tailwind CSS': <SiTailwindcss />,
  'Bootstrap': <SiBootstrap />, 'Vite': <SiVite />, 'Node.js': <SiNodedotjs />,
  'Express.js': <SiExpress />, 'MongoDB': <SiMongodb />, 'Firebase': <SiFirebase />,
  'Git': <SiGit />, 'GitHub': <FaGithub />
};

const projects = [
  {
    title: 'Thumbmax', year: '2026', stack: 'Node.js • Express.js • Gemini API • Cloudinary',
    bullets: ['Built a scalable AI-powered thumbnail generation platform.', 'Integrated Gemini API and Cloudinary.', 'Implemented JWT authentication and API rate limiting.', 'Deployed production-ready application on Vercel.'],
    link: 'thumbmax-psi.vercel.app',
  },
  {
    title: 'Postify', year: '2025', stack: 'Node.js • Express.js • MongoDB',
    bullets: ['Developed a full-stack social media application.', 'Built REST APIs for authentication, feeds and posts.', 'Implemented secure CRUD operations.', 'Used JWT authentication for access control.'],
    link: 'github.com/siddharthNirmale/Feed-Pin',
  },
  {
    title: 'E-Commerce', year: '2025', stack: 'React.js • Vite • JavaScript',
    bullets: ['Built responsive e-commerce user interface.', 'Implemented filtering and category navigation.', 'Used React Hooks for state management.', 'Optimized for cross-device compatibility.'],
...
export default function ResumeSection() {
  return (
    <div className="min-h-screen bg-black p-4 md:p-10 font-mono custom-scrollbar">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end border-b border-neutral-900 pb-4 mb-6 gap-4">
          <div>
        ...
        <div className="bg-[#050505] border border-neutral-800 relative mb-6">
          ...
          <div className="p-6 pl-8">
            <h2 className="text-xl sm:text-2xl font-bold uppercase tracking-widest text-white">Siddharth Nirmale</h2>
            <p className="text-[#f02020] text-[10px] uppercase tracking-[0.25em] mt-2">Full Stack Developer</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6 text-[11px] uppercase tracking-widest text-neutral-400">
...
function Info({ icon, text, href }) {
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 hover:text-white transition-colors truncate">
      {icon}
...
function StatCard({ label, value }) {
  return (
    <div className="bg-[#050505] border border-neutral-800 p-4 text-center">
      <div className="text-[10px] uppercase tracking-widest text-neutral-500">{label}</div>
      <div className="mt-2 text-xl sm:text-3xl font-bold text-white">{value}</div>
    </div>
  );
}
...
function TechBadge({ label, icon }) {
  return (
    <div className="flex items-center gap-2 border border-neutral-800 bg-black px-2 sm:px-3 py-2 text-[9px] sm:text-[10px] uppercase tracking-widest text-neutral-400 hover:border-[#f02020] hover:text-white transition-all">
      {icon}
      {label}
    </div>
  );
